    ...
    <div class="auth-card p-6 md:p-8">
      <form @submit.prevent="loginUser" class="space-y-5">
        ...
        <div class="space-y-2">
          <div class="flex justify-between items-center">
            ...
            <NuxtLink to="/forgot" class="text-xs font-medium text-blue-600 dark:text-blue-400 hover:underline">
              Forgot?
            </NuxtLink>
          </div>
          <input
      ...
      <div class="mt-8 text-center pt-6 border-t border-gray-100 dark:border-gray-700">
        <p class="text-sm text-gray-600 dark:text-gray-400">
          ...
          <NuxtLink to="/register" class="text-blue-600 dark:text-blue-400 font-bold hover:underline">
            Sign Up
          </NuxtLink>
        </p>
      </div>
