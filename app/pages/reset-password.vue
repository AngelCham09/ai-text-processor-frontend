  ...
  <div class="w-full max-w-[400px] px-4 mx-auto">
    ...
    <div class="auth-card p-6 md:p-8">
      ...
      <form @submit.prevent="handleReset" class="space-y-5">
        <AuthPasswordInput v-model="form.password" label="New Password" required>
        </AuthPasswordInput>

        <AuthPasswordInput v-model="form.password_confirmation" label="Confirm Password" required>
        </AuthPasswordInput>
